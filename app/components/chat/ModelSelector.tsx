...
export const ModelSelector = ({
  ...
  const filteredModels = useMemo(() => {
    ...
    return baseModels
      ...
      .sort((a, b) => {
        // When searching, sort by relevance (highest score first).
        // When not searching, preserve the source order, which is defined
        // per-provider as latest (top) → oldest (bottom).
