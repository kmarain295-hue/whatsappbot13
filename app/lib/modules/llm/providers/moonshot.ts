...
export default class MoonshotProvider extends BaseProvider {
  ...
  staticModels: ModelInfo[] = [
    // ===== Kimi K3 (Latest Flagship - 2025) =====
    {
      name: 'kimi-k3',
      label: 'Kimi K3 (Latest Flagship)',
      provider: 'Moonshot',
    ...
    // ===== Kimi K2.6 (2025) =====
    { name: 'kimi-k2.6', label: 'Kimi K2.6', provider: 'Moonshot', maxTokenAllowed: 256000, maxCompletionTokens: 8192 },
    ...
    // ===== Moonshot v1 Vision Series (2024) =====
    {
