...
export default class ZaiProvider extends BaseProvider {
  ...
  staticModels: ModelInfo[] = [
    // ===== GLM-5 Series (Latest - 2025) =====
    {
      name: 'glm-5.2',
      label: 'GLM-5.2 (1M Context, Latest Flagship)',
      provider: 'Z.ai',
    ...
    {
      name: 'glm-5-turbo',
      label: 'GLM-5 Turbo (Fast Inference)',
      provider: 'Z.ai',
