...
export class LLMManager {
  ...
  async updateModelList(options: {
    ...
    // NOTE: We intentionally do NOT sort alphabetically here — each provider's
    // staticModels are already ordered latest (top) → oldest (bottom), and we
    // preserve that order so the model dropdown shows newest models first.
  ...
  async getModelListFromProvider(
    ...
    // NOTE: preserve source order (latest → oldest) instead of sorting alphabetically.
