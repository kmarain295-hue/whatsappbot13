...
export default defineConfig({
  safelist: [
    ...
    /*
     * SDK tool icons (Tools tab in the Control Panel) — these are referenced
     * dynamically from app/lib/sdk-tool-registry.ts (`tool.icon`), so UnoCSS's
     * scanner does not reliably pick them up. Safelisting them guarantees their
     * mask CSS is always generated and the icons render.
     */
